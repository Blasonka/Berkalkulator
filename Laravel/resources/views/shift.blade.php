                            ...
                            @foreach ($shifts as $shift)
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#editModal" data-id="{{ $shift->id }}">
                                            Szerkesztés</button>
                        ...
                        <form action="{{ route('delete_shift', $shift->id) }}" method="POST">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="deleteProfileLabel">Beosztás törlése</h1>
                ...
                <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true"
                    ...
                    <div class="modal-dialog">
                        <form action="{{ route('update_shift', $shift->id) }}" method="POST">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="deleteProfileLabel">Beosztás szerkesztése</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="row col-lg-10 mb-3 mx-auto">
                                        ...
                                        <div class="mx-auto">
                                            <input type="date" id="date" name="date"
                                                value="{{ date('Y-m-d', strtotime($shift->start_time)) }}" required
                                    ...
                                    <div class="row col-lg-10 mb-3 mx-auto">
                                        ...
                                        <div class="mx-auto">
                                            <input type="time" id="start_time" name="start_time" min="00:00"
                                                max="23:59" required value="{{ $shift->start_time }}">
                                        </div>
                                    </div>
                                    <div class="row col-lg-10 mb-3 mx-auto">
                                        <label for="end_time" class="form-label">Munka vége</label>
                                        <div class="mx-auto">
                                            <input type="time" id="end_time" name="end_time" min="00:00"
                                                max="23:59" required value="{{ $shift->end_time }}">
                                        </div>
                                    </div>
                                    <div class="row col-lg-10 mb-3 mx-auto">
                                        <label for="hourly_wage" class="form-label">Órabér</label>
                                        <div class="mx-auto">
                                            <input type="number" id="hourly_wage" name="hourly_wage" min="1000"
                                                max="10000" value="{{ $shift->hourly_wage }}" required>
                                    ...
                                    <div class="row col-lg-10 mb-3 mx-auto">
                                        <div class="mx-auto">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="doublepay"
                                                    name="doublepay">
